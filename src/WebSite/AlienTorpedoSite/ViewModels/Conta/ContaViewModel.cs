...
namespace AlienTorpedoSite.ViewModels.Conta
{
    public class ContaViewModel
    {
        ...
        [StringLength(80, ErrorMessage = "O [{0}] deve conter no máximo 80 caractéres!")]
        ...
        [Display(Name = "Senha")]
        [Required(ErrorMessage = "O campo [{0}] é obrigatório!")]
        [StringLength(20, MinimumLength = 8, ErrorMessage = "A campo [{0}] deve conter no mínimo 8 e no máximo 20 caractéres!")]
